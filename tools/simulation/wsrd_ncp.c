...
void ns3_ncp_recv(const void *_req, const void *req_data, void *_cnf, void *cnf_data)
{
    static const struct {
        ...
        [SL_WISUN_MSG_SENDTO_ON_SOCKET_REQ_ID]               = { ncp_sk_sendto,     sizeof(sl_wisun_msg_sendto_on_socket_req_t),               SL_WISUN_MSG_SENDTO_ON_SOCKET_CNF_ID,               sizeof(sl_wisun_msg_sendto_on_socket_cnf_t) },
        ...
        [SL_WISUN_MSG_CONNECT_SOCKET_REQ_ID]                 = { ncp_sk_connect,    sizeof(sl_wisun_msg_connect_socket_req_t),                 SL_WISUN_MSG_CONNECT_SOCKET_CNF_ID,                 sizeof(sl_wisun_msg_connect_socket_cnf_t) },
