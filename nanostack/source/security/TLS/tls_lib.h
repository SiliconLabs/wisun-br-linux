...
extern void tls_finish_copy(uint8_t *ptr, tls_heap_t *heap_ptr);
...
extern uint8_t *tls_build_change_chipher_suite_finish_msg(uint8_t *ptr, tls_session_t *tls_session);
