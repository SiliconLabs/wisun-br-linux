...
const struct chan_params chan_params_table[] = {
    ...
    { REG_DOMAIN_JP, 1, HIF_REG_ARIB,   0,  920600000,  200000,  38, { 0x02                                     }, },
    { REG_DOMAIN_JP, 2, HIF_REG_ARIB,   0,  920900000,  400000,  18, { 0x04, 0x05                               }, },
    { REG_DOMAIN_JP, 3, HIF_REG_ARIB,   0,  920800000,  600000,  12, { 0x07, 0x08                               }, },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  21,  920600000,  200000,  38, { 0x02, 0x12, 0x54, 0x55, 0x56             }, .chan_allowed = "9-37", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  22,  920900000,  400000,  18, { 0x04, 0x05, 0x14, 0x15, 0x44, 0x45, 0x46 }, .chan_allowed = "4-17", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  23,  920800000,  600000,  12, { 0x07, 0x08, 0x17, 0x18                   }, .chan_allowed = "3-11", },
