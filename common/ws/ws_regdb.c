...
const struct chan_params chan_params_table[] = {
    ...
    { REG_DOMAIN_BZ, 0, HIF_REG_NONE,   4,  902800000,  800000,  31, { 0x33, 0x34, 0x35, 0x36                   }, .chan_allowed = "0-4,17-30", },
    // NODE: Duplicate entry with different channel count for backward compatibility with legacy radio configurator
    { REG_DOMAIN_BZ, 0, HIF_REG_NONE,   4,  902800000,  800000,  32, { 0x33, 0x34, 0x35, 0x36                   }, .chan_allowed = "0-4,17-30", },
    { REG_DOMAIN_BZ, 0, HIF_REG_NONE,   5,  903200000, 1200000,  20, { 0x22, 0x23, 0x24, 0x25, 0x26             }, .chan_allowed = "0-2,11-19", },
    // NODE: Duplicate entry with different channel count for backward compatibility with legacy radio configurator
    ...
    { REG_DOMAIN_CN, 4, HIF_REG_NONE, 128,  920625000,  250000,  16, { 0x02, 0x03, 0x05, 0x12, 0x13, 0x15       }, },
    { REG_DOMAIN_EU, 1, HIF_REG_NONE,   0,  863100000,  100000,  69, { 0x01                                     }, },
    { REG_DOMAIN_EU, 2, HIF_REG_NONE,   0,  863100000,  200000,  35, { 0x03, 0x05                               }, },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  32,  863100000,  100000,  69, { 0x01, 0x11                               }, .chan_allowed = "0-54,57-60,64,67-68", },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  33,  863100000,  200000,  35, { 0x03, 0x05, 0x13, 0x15, 0x54, 0x55, 0x56 }, .chan_allowed = "0-26,29,34", },
    { REG_DOMAIN_EU, 3, HIF_REG_NONE,  34,  870100000,  100000,  55, { 0x01, 0x11                               }, },
    { REG_DOMAIN_EU, 4, HIF_REG_NONE,  35,  870200000,  200000,  27, { 0x03, 0x05, 0x13, 0x15, 0x54, 0x55, 0x56 }, },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  36,  863100000,  100000, 125, { 0x01, 0x11                               }, .chan_allowed = "0-54,57-60,64,67-124", },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  37,  863100000,  200000,  62, { 0x03, 0x05, 0x13, 0x15, 0x54, 0x55, 0x56 }, .chan_allowed = "0-26,29,34-61", },
    { REG_DOMAIN_HK, 1, HIF_REG_NONE,  64,  920200000,  200000,  24, { 0x02, 0x03, 0x12, 0x13                   }, },
    { REG_DOMAIN_HK, 2, HIF_REG_NONE,  65,  920400000,  400000,  12, { 0x05, 0x06, 0x08, 0x15, 0x16, 0x18       }, },
    { REG_DOMAIN_IN, 1, HIF_REG_WPC,   39,  865100000,  100000,  29, { 0x01, 0x11                               }, },
    { REG_DOMAIN_IN, 2, HIF_REG_WPC,   40,  865100000,  200000,  15, { 0x03, 0x05, 0x13, 0x15, 0x54, 0x55, 0x56 }, },
    { REG_DOMAIN_JP, 1, HIF_REG_ARIB,  21,  920600000,  200000,  38, { 0x02, 0x12, 0x54, 0x55, 0x56             }, .chan_allowed = "9-37", },
    { REG_DOMAIN_JP, 2, HIF_REG_ARIB,  22,  920900000,  400000,  18, { 0x04, 0x05, 0x14, 0x15, 0x44, 0x45, 0x46 }, .chan_allowed = "4-17", },
    { REG_DOMAIN_JP, 3, HIF_REG_ARIB,  23,  920800000,  600000,  12, { 0x07, 0x08, 0x17, 0x18                   }, .chan_allowed = "3-11", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  24,  921100000,  800000,   9, { 0x33, 0x34, 0x35, 0x36                   }, .chan_allowed = "2-8", },
    { REG_DOMAIN_KR, 1, HIF_REG_NONE,  96,  917100000,  200000,  32, { 0x02, 0x03, 0x12, 0x13                   }, },
    { REG_DOMAIN_KR, 2, HIF_REG_NONE,  97,  917300000,  400000,  16, { 0x05, 0x06, 0x08, 0x15, 0x16, 0x18       }, },
    { REG_DOMAIN_MX, 1, HIF_REG_NONE,   1,  902200000,  200000, 129, { 0x02, 0x03, 0x12, 0x13                   }, },
    { REG_DOMAIN_MX, 2, HIF_REG_NONE,   2,  902400000,  400000,  64, { 0x05, 0x06, 0x08, 0x15, 0x16, 0x18       }, },
    { REG_DOMAIN_MY, 1, HIF_REG_NONE,  80,  919200000,  200000,  19, { 0x02, 0x03, 0x12, 0x13                   }, },
    { REG_DOMAIN_MY, 2, HIF_REG_NONE,  81,  919200000,  400000,  10, { 0x05, 0x06, 0x08, 0x15, 0x16, 0x18       }, },
    { REG_DOMAIN_NA, 1, HIF_REG_NONE,   1,  902200000,  200000, 129, { 0x02, 0x03, 0x12, 0x13, 0x54, 0x55, 0x56 }, },
    { REG_DOMAIN_NA, 2, HIF_REG_NONE,   2,  902400000,  400000,  64, { 0x05, 0x06, 0x15, 0x16, 0x44, 0x45, 0x46 }, },
    { REG_DOMAIN_NA, 3, HIF_REG_NONE,   3,  902600000,  600000,  42, { 0x08, 0x18                               }, },
    { REG_DOMAIN_NA, 0, HIF_REG_NONE,   4,  902800000,  800000,  31, { 0x33, 0x34, 0x35, 0x36                   }, },
    // NODE: Duplicate entry with different channel count for backward compatibility with legacy radio configurator
    { REG_DOMAIN_NA, 0, HIF_REG_NONE,   4,  902800000,  800000,  32, { 0x33, 0x34, 0x35, 0x36                   }, .chan_allowed = "0-30" },
    { REG_DOMAIN_NA, 0, HIF_REG_NONE,   5,  903200000, 1200000,  20, { 0x22, 0x23, 0x24, 0x25, 0x26             }, },
    // NODE: Duplicate entry with different channel count for backward compatibility with legacy radio configurator
    { REG_DOMAIN_NA, 0, HIF_REG_NONE,   5,  903200000, 1200000,  21, { 0x22, 0x23, 0x24, 0x25, 0x26             }, .chan_allowed = "0-19" },
    { REG_DOMAIN_PH, 1, HIF_REG_NONE,   0,  915200000,  200000,  14, { 0x02, 0x03                               }, },
    ...
    { REG_DOMAIN_VN, 2, HIF_REG_NONE,  65,  920400000,  400000,  12, { 0x05, 0x06, 0x08, 0x15, 0x16, 0x18       }, },
    { REG_DOMAIN_WW, 1, HIF_REG_NONE, 112, 2400200000,  200000, 416, { 0x02, 0x03, 0x12, 0x13                   }, },
    { REG_DOMAIN_WW, 2, HIF_REG_NONE, 113, 2400400000,  400000, 207, { 0x05, 0x06, 0x08, 0x15, 0x16, 0x18       }, },
