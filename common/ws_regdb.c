...
const struct chan_params chan_params_table[] = {
    ...
    { REG_DOMAIN_AZ, 1, HIF_REG_NONE,  48,  915200000,  200000,  64,  64, {  2,  3, 18, 19              }, }, // REG_DOMAIN_AZ and REG_DOMAIN_NZ share the same ID
    { REG_DOMAIN_AZ, 2, HIF_REG_NONE,  49,  915400000,  400000,  32,  32, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_BZ, 1, HIF_REG_NONE,   1,  902200000,  200000, 129,  90, {  2,  3, 18, 19, 84, 85, 86, }, .chan_allowed = "0-25,65-255", },
    { REG_DOMAIN_BZ, 2, HIF_REG_NONE,   2,  902400000,  400000,  64,  43, {  5,  6, 21, 22, 68, 69, 70, }, .chan_allowed = "0-11,33-255", },
    { REG_DOMAIN_BZ, 3, HIF_REG_NONE,   3,  902600000,  600000,  42,  28, {  8, 24,                     }, .chan_allowed = "0-7,22-255", },
    { REG_DOMAIN_BZ, 0, HIF_REG_NONE,   4,  902800000,  800000,  32,  22, { 51, 52, 53, 54,             }, .chan_allowed = "0-5,16-255", },
    { REG_DOMAIN_BZ, 0, HIF_REG_NONE,   5,  903200000, 1200000,  21,  13, { 34, 35, 36, 37, 38,         }, .chan_allowed = "0-2,11-255", },
    { REG_DOMAIN_CN, 1, HIF_REG_NONE, 160,  470200000,  200000, 199, 199, {  2,  3,  5, 18, 19, 21      }, },
    { REG_DOMAIN_CN, 2, HIF_REG_NONE,   0,  779200000,  200000,  39,  39, {  2,  3,                     }, },
    { REG_DOMAIN_CN, 3, HIF_REG_NONE,   0,  779400000,  400000,  19,  19, {  5,  6,  8,                 }, },
    { REG_DOMAIN_CN, 4, HIF_REG_NONE, 128,  920625000,  250000,  16,  16, {  2,  3,  5, 18, 19, 21      }, },
    { REG_DOMAIN_EU, 1, HIF_REG_NONE,   0,  863100000,  100000,  69,  69, {  1,                         }, },
    { REG_DOMAIN_EU, 2, HIF_REG_NONE,   0,  863100000,  200000,  35,  35, {  3,  5,                     }, },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  32,  863100000,  100000,  69,  62, {  1, 17,                     }, .chan_allowed = "0-54,57-60,64,67-255", },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  33,  863100000,  200000,  35,  29, {  3,  5, 19, 21, 84, 85, 86, }, .chan_allowed = "0-26,29,34-255", },
    { REG_DOMAIN_EU, 3, HIF_REG_NONE,  34,  870100000,  100000,  55,  55, {  1, 17,                     }, },
    { REG_DOMAIN_EU, 4, HIF_REG_NONE,  35,  870200000,  200000,  27,  27, {  3,  5, 19, 21, 84, 85, 86, }, },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  36,  863100000,  100000, 125, 118, {  1, 17,                     }, .chan_allowed = "0-54,57-60,64,67-255", },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  37,  863100000,  200000,  62,  56, {  3,  5, 19, 21, 84, 85, 86, }, .chan_allowed = "0-26,29,34-255", },
    { REG_DOMAIN_HK, 1, HIF_REG_NONE,  64,  920200000,  200000,  24,  24, {  2,  3, 18, 19              }, },
    { REG_DOMAIN_HK, 2, HIF_REG_NONE,  65,  920400000,  400000,  12,  12, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_IN, 1, HIF_REG_NONE,  39,  865100000,  100000,  29,  29, {  1, 17                      }, },
    { REG_DOMAIN_IN, 2, HIF_REG_NONE,  40,  865100000,  200000,  15,  15, {  3,  5, 19, 21, 84, 85, 86  }, },
    { REG_DOMAIN_JP, 1, HIF_REG_ARIB,   0,  920600000,  200000,  38,  38, {  2,                         }, },
    { REG_DOMAIN_JP, 2, HIF_REG_ARIB,   0,  920900000,  400000,  18,  18, {  4,  5,                     }, },
    { REG_DOMAIN_JP, 3, HIF_REG_ARIB,   0,  920800000,  600000,  12,  12, {  7,  8,                     }, },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  21,  920600000,  200000,  38,  29, {  2, 18, 84, 85, 86,         }, .chan_allowed = "9-255", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  22,  920900000,  400000,  18,  14, {  4,  5, 20, 21, 68, 69, 70, }, .chan_allowed = "4-255", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  23,  920800000,  600000,  12,   9, {  7,  8, 23, 24,             }, .chan_allowed = "3-255", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  24,  921100000,  800000,   9,   7, { 51, 52, 53, 54,             }, .chan_allowed = "2-255", },
    { REG_DOMAIN_KR, 1, HIF_REG_NONE,  96,  917100000,  200000,  32,  32, {  2,  3, 18, 19              }, },
    { REG_DOMAIN_KR, 2, HIF_REG_NONE,  97,  917300000,  400000,  16,  16, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_MX, 1, HIF_REG_NONE,   1,  902200000,  200000, 129, 129, {  2,  3, 18, 19              }, },
    { REG_DOMAIN_MX, 2, HIF_REG_NONE,   2,  902400000,  400000,  64,  64, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_MY, 1, HIF_REG_NONE,  80,  919200000,  200000,  19,  19, {  2,  3, 18, 19              }, },
    { REG_DOMAIN_MY, 2, HIF_REG_NONE,  81,  919200000,  400000,  10,  10, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_NA, 1, HIF_REG_NONE,   1,  902200000,  200000, 129, 129, {  2,  3, 18, 19, 84, 85, 86, }, },
    { REG_DOMAIN_NA, 2, HIF_REG_NONE,   2,  902400000,  400000,  64,  64, {  5,  6, 21, 22, 68, 69, 70, }, },
    { REG_DOMAIN_NA, 3, HIF_REG_NONE,   3,  902600000,  600000,  42,  42, {  8, 24,                     }, },
    { REG_DOMAIN_NA, 0, HIF_REG_NONE,   4,  902800000,  800000,  32,  32, { 51, 52, 53, 54,             }, },
    { REG_DOMAIN_NA, 0, HIF_REG_NONE,   5,  903200000, 1200000,  21,  21, { 34, 35, 36, 37, 38,         }, },
    { REG_DOMAIN_PH, 1, HIF_REG_NONE,   0,  915200000,  200000,  14,  14, {  2,  3,                     }, },
    { REG_DOMAIN_PH, 2, HIF_REG_NONE,   0,  915400000,  400000,   7,   7, {  5,  6,  8,                 }, },
    { REG_DOMAIN_PH, 0, HIF_REG_NONE,  48,  915200000,  200000,  64,  14, {  2,  3,  18, 19             }, .chan_allowed = "0-13", },
    { REG_DOMAIN_PH, 0, HIF_REG_NONE,  49,  915400000,  400000,  32,   7, {  5,  6,  8,  21, 22, 24     }, .chan_allowed = "0-6", },
    { REG_DOMAIN_SG, 1, HIF_REG_NONE,   0,  866100000,  100000,  29,  29, {  1,                         }, },
    { REG_DOMAIN_SG, 2, HIF_REG_NONE,   0,  866100000,  200000,  15,  15, {  3,  5,                     }, },
    { REG_DOMAIN_SG, 3, HIF_REG_NONE,   0,  866300000,  400000,   7,   7, {  6,  8,                     }, },
    { REG_DOMAIN_SG, 0, HIF_REG_NONE,  32,  863100000,  100000,  69,  29, {  1, 17                      }, .chan_allowed = "30-58", },
    { REG_DOMAIN_SG, 0, HIF_REG_NONE,  33,  863100000,  200000,  35,  15, {  3,  5, 18, 21              }, .chan_allowed = "15-29", },
    { REG_DOMAIN_SG, 0, HIF_REG_NONE,  38,  863500000,  400000,  16,   7, {  6,  8, 22, 24              }, .chan_allowed = "7-13", },
    { REG_DOMAIN_SG, 4, HIF_REG_NONE,  64,  920200000,  200000,  24,  24, {  2,  3,                     }, },
    { REG_DOMAIN_SG, 5, HIF_REG_NONE,  65,  920400000,  400000,  12,  12, {  5,  6,  8,                 }, },
    { REG_DOMAIN_TH, 1, HIF_REG_NONE,  64,  920200000,  200000,  24,  24, {  2,  3, 18, 19              }, },
    { REG_DOMAIN_TH, 2, HIF_REG_NONE,  65,  920400000,  400000,  12,  12, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_VN, 1, HIF_REG_NONE,  64,  920200000,  200000,  24,  24, {  2,  3, 18, 19              }, },
    { REG_DOMAIN_VN, 2, HIF_REG_NONE,  65,  920400000,  400000,  12,  12, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_WW, 1, HIF_REG_NONE, 112, 2400200000,  200000, 416, 416, {  2,  3, 18, 19              }, },
    { REG_DOMAIN_WW, 2, HIF_REG_NONE, 113, 2400400000,  400000, 207, 207, {  5,  6,  8, 21, 22, 24      }, },
    { REG_DOMAIN_UNDEF, 0, HIF_REG_NONE, 0,         0,       0,   0,   0, {                             }, },
};
