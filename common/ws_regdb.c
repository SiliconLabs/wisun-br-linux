...
const struct chan_params chan_params_table[] = {
    ...
    { REG_DOMAIN_BZ, 2, HIF_REG_NONE,   2,  902400000,  400000,  64, {  5,  6, 21, 22, 68, 69, 70, }, .chan_allowed = "0-11,33-255", },
    { REG_DOMAIN_BZ, 3, HIF_REG_NONE,   3,  902600000,  600000,  42, {  8, 24,                     }, .chan_allowed = "0-7,22-255", },
    { REG_DOMAIN_BZ, 0, HIF_REG_NONE,   4,  902800000,  800000,  32, { 51, 52, 53, 54,             }, .chan_allowed = "0-5,16-255", },
    { REG_DOMAIN_BZ, 0, HIF_REG_NONE,   5,  903200000, 1200000,  21, { 34, 35, 36, 37, 38,         }, .chan_allowed = "0-2,11-255", },
    ...
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  32,  863100000,  100000,  69, {  1, 17,                     }, .chan_allowed = "0-54,57-60,64,67-255", },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  33,  863100000,  200000,  35, {  3,  5, 19, 21, 84, 85, 86, }, .chan_allowed = "0-26,29,34-255", },
    ...
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  36,  863100000,  100000, 125, {  1, 17,                     }, .chan_allowed = "0-54,57-60,64,67-255", },
    { REG_DOMAIN_EU, 0, HIF_REG_NONE,  37,  863100000,  200000,  62, {  3,  5, 19, 21, 84, 85, 86, }, .chan_allowed = "0-26,29,34-255", },
    ...
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  21,  920600000,  200000,  38, {  2, 18, 84, 85, 86,         }, .chan_allowed = "9-255", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  22,  920900000,  400000,  18, {  4,  5, 20, 21, 68, 69, 70, }, .chan_allowed = "4-255", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  23,  920800000,  600000,  12, {  7,  8, 23, 24,             }, .chan_allowed = "3-255", },
    { REG_DOMAIN_JP, 0, HIF_REG_ARIB,  24,  921100000,  800000,   9, { 51, 52, 53, 54,             }, .chan_allowed = "2-255", },
    ...
    { REG_DOMAIN_SG, 1, HIF_REG_NONE,   0,  866100000,  100000,  29, {  1,                         }, },
    { REG_DOMAIN_SG, 2, HIF_REG_NONE,   0,  866100000,  200000,  15, {  3,  5,                     }, },
    { REG_DOMAIN_SG, 3, HIF_REG_NONE,   0,  866300000,  400000,   7, {  6,  8,                     }, },
    { REG_DOMAIN_SG, 0, HIF_REG_NONE,  32,  863100000,  100000,  69, {  1, 17                      }, .chan_allowed = "30-58", },
    { REG_DOMAIN_SG, 0, HIF_REG_NONE,  33,  863100000,  200000,  35, {  3,  5, 18, 21              }, .chan_allowed = "15-29", },
    { REG_DOMAIN_SG, 0, HIF_REG_NONE,  38,  863500000,  400000,  16, {  6,  8, 22, 24              }, .chan_allowed = "7-13", },
