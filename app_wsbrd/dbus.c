...
static const sd_bus_vtable dbus_vtable[] = {
        ...
        SD_BUS_METHOD_WITH_ARGS("JoinMulticastGroup",
                                SD_BUS_ARGS("ay", group), SD_BUS_NO_RESULT,
                                dbus_join_multicast_group,  0),
        SD_BUS_METHOD_WITH_ARGS("LeaveMulticastGroup",
                                SD_BUS_ARGS("ay", group), SD_BUS_NO_RESULT,
                                dbus_leave_multicast_group, 0),
        SD_BUS_METHOD_WITH_ARGS("SetModeSwitch",
                                SD_BUS_ARGS("ay", eui64, "i", phy_mode_id), SD_BUS_NO_RESULT,
                                dbus_set_mode_switch, 0),
        SD_BUS_METHOD_WITH_ARGS("SetSlotAlgorithm",
                                SD_BUS_ARGS("y", mode), SD_BUS_NO_RESULT,
                                dbus_set_slot_algorithm, 0),
        SD_BUS_METHOD_WITH_ARGS("RevokePairwiseKeys",
                                SD_BUS_ARGS("ay", eui64), SD_BUS_NO_RESULT,
