...
#define   HIF_FHSS_CHAN_FUNC_FIXED   WS_CHAN_FUNC_FIXED  // 0x00
#define   HIF_FHSS_CHAN_FUNC_TR51    WS_CHAN_FUNC_TR51CF         // 0x01
#define   HIF_FHSS_CHAN_FUNC_DH1     WS_CHAN_FUNC_DH1CF          // 0x02
                ...
                uint8_t priority, uint8_t phy_id)
{
    ...
    if (fhss_type == HIF_FHSS_TYPE_FFN_UC || fhss_type == HIF_FHSS_TYPE_LFN_UC || fhss_type == HIF_FHSS_TYPE_LFN_PA) {
        ...
        case WS_CHAN_FUNC_FIXED:
            flags |= FIELD_PREP(HIF_FHSS_CHAN_FUNC_MASK, WS_CHAN_FUNC_FIXED);
            hif_push_u16(&buf, neighbor_ws->fhss_data.uc_chan_fixed);
            break;
        case WS_CHAN_FUNC_DH1CF:
            flags |= FIELD_PREP(HIF_FHSS_CHAN_FUNC_MASK, WS_CHAN_FUNC_DH1CF);
