                       ...
                       void (*print_help)(FILE *stream))
{
    const struct option_struct wsbrd_opts[] = {
        ...
        { "user",                          offsetof(struct wsbrd_conf, user),                             conf_set_string,      (void *)sizeof(config->user) },
        { "group",                         offsetof(struct wsbrd_conf, group),                            conf_set_string,      (void *)sizeof(config->group) },
        ...
        { "phy_operating_modes",           offsetof(struct wsbrd_conf, ws_phy_op_modes),                  conf_set_phy_op_modes, &valid_ws_phy_mode_ids },
        ...
        { "allowed_channels",              offsetof(struct wsbrd_conf, ws_allowed_channels),              conf_set_bitmask,     NULL },
        { "custom_allowed_channels",       offsetof(struct wsbrd_conf, ws_custom_allowed_channels),       conf_set_bitmask,     NULL },
        { "pan_id",                        offsetof(struct wsbrd_conf, ws_pan_id),                        conf_set_number,      &valid_pan_id },
        { "enable_lfn",                    offsetof(struct wsbrd_conf, enable_lfn),                       conf_set_bool,        NULL },
        { "enable_ffn10",                  offsetof(struct wsbrd_conf, enable_ffn10),                     conf_set_bool,        NULL },
