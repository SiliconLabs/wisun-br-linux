...
Example:
    ...
    # config
    SetLinkEdfe [0x00, 0x00, 0x5e, 0xef, 0x10, 0x00, 0x00, 0x00] 2

    # Disable EDFE on neighbor 00:00:5e:ef:10:00:00:01
    SetLinkEdfe [0x00, 0x00, 0x5e, 0xef, 0x10, 0x00, 0x00, 0x01] 1

    # Reset neighbor 00:00:5e:ef:10:00:00:00 EDFE to global
    SetLinkEdfe [0x00, 0x00, 0x5e, 0xef, 0x10, 0x00, 0x00, 0x00] 0
...
|`is_authenticated`|`b`      |                                                                          |
|`eapol_target`    |`ay`     |IPv6 address of the temporary parent used during authentication.          |
